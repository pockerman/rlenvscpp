...
from gymnasium_envs.box2d.lunar_lander_env_continuous_api import lunar_lander_continuous_router
...
app.include_router(lunar_lander_continuous_router, prefix=BASE_URL)
